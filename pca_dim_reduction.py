# -*- coding: utf-8 -*-
"""
Created on Mon May 17 17:14:51 2021
...
experiment_dir = r'C:\Users\Safwen\.spyder-py3\Self Supervised learning\experiments\self-supervised\ssl_exp'

feature_path=os.path.join(experiment_dir,'features_11')
...
explained_variance
print(np.sum(explained_variance[0:218]))
