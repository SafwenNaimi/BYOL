# -*- coding: utf-8 -*-
"""
Created on Mon May 17 13:24:06 2021
...
def save_features_as_dict(model,dloader,sf,feat_path,label_path,num_batch=10):
    ...
    for input_batch,label in tqdm(dloader):
...
if __name__=='__main__':
    ...
    experiment_dir = r'C:\Users\Safwen\.spyder-py3\BYOL\PyTorch-BYOL-master\experiments\self-supervised'
    restore_file = 'byol-final.pth'
...
#    params = utils.Params(yaml_path)
    ...
    cfg.batch_size=1
    cfg.root_path = r'C:\Users\Safwen\.spyder-py3\BYOL\PyTorch-BYOL-master'
...
#    layer_name=model.layer2[1]
    layer_name=model.layer1[1]
    #summary(model,(3,96,96))

    
    # save the feature embeddings for every image
    features_path=os.path.join(experiment_dir,'features_1')
