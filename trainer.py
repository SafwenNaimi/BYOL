...
def _create_model_training_folder(writer, files_to_same):
    model_checkpoints_folder = ('Python Scripts/BYOL/experiments/self-supervised/runs/checkpoints')
...
class BYOLTrainer:
    def __init__(self, online_network, target_network, predictor, optimizer, device, **params):
        ...
        _create_model_training_folder(self.writer, files_to_same=["Python Scripts/BYOL/config/config.yaml", "Python Scripts/BYOL/main.py", 'Python Scripts/BYOL/trainer.py'])
    ...
    def train(self, train_dataset):
        ...
        config_path = r'Python Scripts/Self Supervised Learning/config/config_sl.yaml'
        ...
        for epoch_counter in range(self.max_epochs):
            ...
            if epoch_counter % 100 == 0:
                self.save_model('Python Scripts/BYOL/experiments/self-supervised/model_adam{}.pth'.format(epoch_counter))

        # save checkpoints
        self.save_model('Python Scripts/BYOL/experiments/self-supervised/model_adam.pth')
